...
function $s_LMatrixButtons__main__AT__V(args) {
  $m_LMatrixButtons$().main__AT__V(args);
}
/** @constructor */
function $c_LMatrixButtons$() {
  this.LMatrixButtons$__f_buttonLabels = null;
  this.LMatrixButtons$__f_buttonLinks = null;
  this.LMatrixButtons$__f_buttonColors = null;
  this.LMatrixButtons$__f_windowWidth = 0;
  this.LMatrixButtons$__f_windowHeight = 0;
  $n_LMatrixButtons$ = this;
  this.LMatrixButtons$__f_buttonLabels = new ($d_T.getArrayOf().constr)(["GITHUB", "ABOUT", "BLOG", "CONTACT"]);
  this.LMatrixButtons$__f_buttonLinks = new ($d_T.getArrayOf().constr)(["https://github.com/qxrein", "https://about.qxrein.xyz", "https://blog.qxrein.xyz", "https://contact.qxrein.xyz"]);
  this.LMatrixButtons$__f_buttonColors = new ($d_T.getArrayOf().constr)(["rgba(128, 0, 128, 0.3)", "rgba(139, 0, 0, 0.3)", "rgba(165, 42, 42, 0.3)", "rgba(255, 140, 0, 0.3)"]);
  this.LMatrixButtons$__f_windowWidth = 0;
  this.LMatrixButtons$__f_windowHeight = 0;
}
$c_LMatrixButtons$.prototype = new $h_O();
$c_LMatrixButtons$.prototype.constructor = $c_LMatrixButtons$;
/** @constructor */
function $h_LMatrixButtons$() {
}
$h_LMatrixButtons$.prototype = $c_LMatrixButtons$.prototype;
$c_LMatrixButtons$.prototype.main__AT__V = (function(args) {
  document.addEventListener("DOMContentLoaded", ((_$1) => {
    $m_LMatrixButtons$().setupMatrix__V();
  }));
});
$c_LMatrixButtons$.prototype.setupMatrix__V = (function() {
  var container = document.getElementById("matrix-container");
  this.updateWindowDimensions__V();
  this.fillViewport__Lorg_scalajs_dom_Element__V(container);
  window.addEventListener("resize", ((_$2) => {
    $m_LMatrixButtons$().updateWindowDimensions__V();
    while ((container.firstChild !== null)) {
      container.removeChild(container.firstChild);
    }
    $m_LMatrixButtons$().fillViewport__Lorg_scalajs_dom_Element__V(container);
  }));
});
$c_LMatrixButtons$.prototype.updateWindowDimensions__V = (function() {
  this.LMatrixButtons$__f_windowWidth = $doubleToInt($uD(window.innerWidth));
  this.LMatrixButtons$__f_windowHeight = $doubleToInt($uD(window.innerHeight));
});
$c_LMatrixButtons$.prototype.fillViewport__Lorg_scalajs_dom_Element__V = (function(container) {
  var x = ((this.LMatrixButtons$__f_windowHeight / 80) | 0);
  var a = x;
  var rowsNeeded = $doubleToInt($uD(Math.ceil(a)));
  var isEmpty = (rowsNeeded <= 0);
  var scala$collection$immutable$Range$$lastElement = (((-1) + rowsNeeded) | 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      $m_LMatrixButtons$().addMatrixRow__Lorg_scalajs_dom_Element__V(container);
...
$c_LMatrixButtons$.prototype.addMatrixRow__Lorg_scalajs_dom_Element__V = (function(container) {
  var row = document.createElement("div");
  row.setAttribute("class", "matrix-row");
  var b = ((this.LMatrixButtons$__f_windowWidth / 150) | 0);
  var buttonsPerRow = ((b < 4) ? 4 : b);
  var isEmpty = (buttonsPerRow <= 0);
  var scala$collection$immutable$Range$$lastElement = (((-1) + buttonsPerRow) | 0);
  if ((!isEmpty)) {
    var i = 0;
    while (true) {
      $m_LMatrixButtons$().addButton__Lorg_scalajs_dom_Element__V(row);
      if ((i === scala$collection$immutable$Range$$lastElement)) {
        break;
      }
      i = ((1 + i) | 0);
...
$c_LMatrixButtons$.prototype.addButton__Lorg_scalajs_dom_Element__V = (function(row) {
  var button = document.createElement("div");
  button.setAttribute("class", "matrix-button");
  var this$1 = $m_s_util_Random$();
  var n = $n(this.LMatrixButtons$__f_buttonLabels).u.length;
  var labelIndex = $n(this$1.s_util_Random__f_self).nextInt__I__I(n);
  var this$2 = $m_s_util_Random$();
  var n$1 = $n(this.LMatrixButtons$__f_buttonColors).u.length;
  var colorIndex = $n(this$2.s_util_Random__f_self).nextInt__I__I(n$1);
  button.textContent = $n(this.LMatrixButtons$__f_buttonLabels).get(labelIndex);
  button.style.backgroundColor = $n(this.LMatrixButtons$__f_buttonColors).get(colorIndex);
  var this$3 = $m_s_util_Random$();
  var width = ((100 + $n(this$3.s_util_Random__f_self).nextInt__I__I(101)) | 0);
...
var $d_LMatrixButtons$ = new $TypeData().initClass($c_LMatrixButtons$, "MatrixButtons$", ({
  LMatrixButtons$: 1
}));
var $n_LMatrixButtons$;
function $m_LMatrixButtons$() {
  if ((!$n_LMatrixButtons$)) {
    $n_LMatrixButtons$ = new $c_LMatrixButtons$();
  }
  return $n_LMatrixButtons$;
}
/** @constructor */
...
$L0 = new $c_RTLong(0, 0);
$d_J.zero = $L0;
$s_LMatrixButtons__main__AT__V(new ($d_T.getArrayOf().constr)([]));
//# sourceMappingURL=matrix-buttons-fastopt.js.map
